...
type Project struct {
	...
	AccessControlType  string  `json:"access_control_type" copier:"AccessControlTypeStr"`
	...
	OrganizationCode   string  `json:"organization_code" copier:"EncryptedOrganizationCode"`
...
type ProjectMember struct {
	...
	JoinTime    int64  `json:"joinTime" copier:"JoinTimeStr"`
