...
var file_task_service_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x32, 0xda, 0x05,
	...
	0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f,
...
var file_task_service_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
var file_task_service_proto_depIdxs = []int32{
	...
	0,  // 10: task.service.v1.TaskService.GetTaskStages:input_type -> task.service.v1.GetTaskStagesReq
	3,  // 11: task.service.v1.TaskService.GetTasksByStageCode:input_type -> task.service.v1.GetTasksByStageCodeReq
	7,  // 12: task.service.v1.TaskService.SaveTask:input_type -> task.service.v1.SaveTaskReq
	9,  // 13: task.service.v1.TaskService.MoveTask:input_type -> task.service.v1.MoveTaskReq
	11, // 14: task.service.v1.TaskService.GetTaskList:input_type -> task.service.v1.GetTaskListReq
	14, // 15: task.service.v1.TaskService.GetTaskDetail:input_type -> task.service.v1.GetTaskDetailReq
	16, // 16: task.service.v1.TaskService.GetTaskMemberList:input_type -> task.service.v1.GetTaskMemberListReq
	19, // 17: task.service.v1.TaskService.GetTaskLogList:input_type -> task.service.v1.GetTaskLogListReq
	2,  // 18: task.service.v1.TaskService.GetTaskStages:output_type -> task.service.v1.GetTaskStagesResp
	6,  // 19: task.service.v1.TaskService.GetTasksByStageCode:output_type -> task.service.v1.GetTasksByStageCodeResp
	8,  // 20: task.service.v1.TaskService.SaveTask:output_type -> task.service.v1.SaveTaskResp
	10, // 21: task.service.v1.TaskService.MoveTask:output_type -> task.service.v1.MoveTaskResp
	13, // 22: task.service.v1.TaskService.GetTaskList:output_type -> task.service.v1.GetTaskListResp
	15, // 23: task.service.v1.TaskService.GetTaskDetail:output_type -> task.service.v1.GetTaskDetailResp
	18, // 24: task.service.v1.TaskService.GetTaskMemberList:output_type -> task.service.v1.GetTaskMemberListResp
	22, // 25: task.service.v1.TaskService.GetTaskLogList:output_type -> task.service.v1.GetTaskLogListResp
