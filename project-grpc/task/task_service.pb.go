...
var file_task_service_proto_depIdxs = []int32{
	...
	0, // 3: task.service.v1.TaskService.GetTaskStages:input_type -> task.service.v1.GetTaskStagesReq
	3, // 4: task.service.v1.TaskService.GetTasksByStageCode:input_type -> task.service.v1.GetTasksByStageCodeReq
	2, // 5: task.service.v1.TaskService.GetTaskStages:output_type -> task.service.v1.GetTaskStagesResp
	6, // 6: task.service.v1.TaskService.GetTasksByStageCode:output_type -> task.service.v1.GetTasksByStageCodeResp
