...
var file_task_service_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x32, 0xbd, 0x03, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x67, 0x65, 0x6e,
...
var file_task_service_proto_depIdxs = []int32{
	...
	0,  // 6: task.service.v1.TaskService.GetTaskStages:input_type -> task.service.v1.GetTaskStagesReq
	3,  // 7: task.service.v1.TaskService.GetTasksByStageCode:input_type -> task.service.v1.GetTasksByStageCodeReq
	7,  // 8: task.service.v1.TaskService.SaveTask:input_type -> task.service.v1.SaveTaskReq
	9,  // 9: task.service.v1.TaskService.MoveTask:input_type -> task.service.v1.MoveTaskReq
	11, // 10: task.service.v1.TaskService.GetTaskList:input_type -> task.service.v1.GetTaskListReq
	2,  // 11: task.service.v1.TaskService.GetTaskStages:output_type -> task.service.v1.GetTaskStagesResp
	6,  // 12: task.service.v1.TaskService.GetTasksByStageCode:output_type -> task.service.v1.GetTasksByStageCodeResp
	8,  // 13: task.service.v1.TaskService.SaveTask:output_type -> task.service.v1.SaveTaskResp
	10, // 14: task.service.v1.TaskService.MoveTask:output_type -> task.service.v1.MoveTaskResp
	13, // 15: task.service.v1.TaskService.GetTaskList:output_type -> task.service.v1.GetTaskListResp
