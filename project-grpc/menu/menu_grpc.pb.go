...
func (c *menuServiceClient) GetMenuTree(ctx context.Context, in *GetMenuTreeReq, opts ...grpc.CallOption) (*GetMenuTreeResp, error) {
	out := new(GetMenuTreeResp)
	err := c.cc.Invoke(ctx, "/menu.service.v1.MenuService/GetMenuTree", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMenuServiceServer) GetMenuTree(context.Context, *GetMenuTreeReq) (*GetMenuTreeResp, error) {
...
func _MenuService_GetMenuTree_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/menu.service.v1.MenuService/GetMenuTree",
	}
